...
// Note: DeepCopy methods need to be generated with controller-gen
// Run: controller-gen object:headerFile="hack/boilerplate.go.txt" paths="./..."
// For now, SchemeBuilder registration is disabled to allow compilation

func init() {
	// TODO: Uncomment after running controller-gen to generate DeepCopy methods
